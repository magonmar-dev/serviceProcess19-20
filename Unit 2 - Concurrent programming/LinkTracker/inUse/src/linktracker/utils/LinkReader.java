...
public class LinkReader extends BufferedReader {
    ...
    /**
     * Override of class that read file lines
     * @return result (line with only links)
     * @throws IOException
     */
    @Override
    ...
    /**
     * Method to get the links inside of a given web page
     * @param urlToParse (web url)
     * @return List<String> (links list)
     */
